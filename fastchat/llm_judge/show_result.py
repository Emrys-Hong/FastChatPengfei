...
def display_result_single(args):
    if args.input_file is None:
        input_file = (
            #f"data/{args.bench_name}/model_judgment/{args.judge_model}_single_{args.model}.jsonl"
            f"data/{args.bench_name}/model_judgment/{args.model}_single.jsonl"
        )
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="A single model to be evaluated",
    )
    parser.add_argument(
        "--model-list",
        type=str,
